    ...
    <div class="container">
        <div class="product">
                ...
                <div class="product-carousel-slider">
                    <ol class="slider-list">
                        <li class="slider-item" role="tabpanel" aria-labelledby="product-carousel-tab-1">
                            <figure>
                                <img src="assets/food-img/beef-burger-1.jpg" />
                            </figure>
                        ...
                        <li class="slider-item" role="tabpanel" aria-labelledby="product-carousel-tab-2">
                            <figure>
                                <img src="assets/food-img/beef-burger-2.jpg" />
                            </figure>
                            <figcaption class="visually-hidden">
                                Beef Burger img-2
                            </figcaption>
                        ...
                        <li class="slider-item" role="tabpanel" aria-labelledby="product-carousel-tab-3">
                            <figure>
                                <img src="assets/food-img/beef-burger-3.jpg" />
                            </figure>
                            <figcaption class="visually-hidden">
                                Beef Burger img-3
                            </figcaption>
                        ...
                        <li class="slider-item" role="tabpanel" aria-labelledby="product-carousel-tab-4">
                            <figure>
                                <img src="assets/food-img/beef-burger-4.jpg" />
                            </figure>
                            <figcaption class="visually-hidden">
                                Beef Burger img-4
                            </figcaption>
                        ...
                        <li class="slider-item" role="tabpanel" aria-labelledby="product-carousel-tab-5">
                            <figure>
                                <img src="assets/food-img/beef-burger-5.jpg" />
                            </figure>
                            <figcaption class="visually-hidden">
                                Beef Burger img-5
                            </figcaption>
            ...
            <!-- <div class="product-img">
                <img src="assets/beef burger.jpg">
            </div> -->
    ...
    <div class="container">
        <div class="product-detail">
            ...
            <div class="ingredient">
                <h3>Ingredient</h3>
                <p>2 pounds ground beef, 1 egg, beaten, ¾ cup dry bread crumbs, 3 tablespoons evaporated milk, 2
                    tablespoons
                    Worcestershire sauce, ⅛ teaspoon cayenne pepper, 2 cloves garlic, minced, 4 hamburger buns (4 in.
                    wide),
                    split, About 1/2 teaspoon salt, About 1/4 cup mayonnaise, About 1/4 cup ketchup, 4 iceberg lettuce
                    leaves, rinsed and crisped, 1 firm-ripe tomato, cored and thinly sliced, 4 thin slices red onion</p>
            </div>
            <iframe class="making-video" width="650" height="400" src="https://www.youtube.com/embed/io6dgoOqj1U"
